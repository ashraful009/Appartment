...
/**
 * Multi-property investment panel. Shows a card per property investment with
 * expand/collapse for details. A "+ Invest in New Property" button opens the
 * BookingCTA with a property selector.
 */
const InvestmentPanel = ({ title = "Investment Dashboard" }) => {
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
      ...
      {/* New Booking CTA — property selector */}
      {showBooking && (
        <BookingCTA onSubmitted={reload} onCancel={() => setShowBooking(false)} />
      )}

      {/* No investments at all — also show BookingCTA */}

  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        console.error("Failed to fetch long-term properties:", err);
      } finally {
        setLoading(false);
      }
    };
      ...
      >
        ...
        <div className="section-wrap relative z-10">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            >
              <Clock size={18} style={{ color: C.goldLight }} />
            </div>
            <span
          ...
          >
            Flexible payment plans designed for long-term financial comfort. Browse all available properties.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p style={{ fontSize: "0.875rem", color: C.textMuted, maxWidth: "320px" }}>
              {activeStatus !== "All"
                ? `No ${activeStatus.toLowerCase()} long-term installment properties available.`
                : "No long-term installment properties available yet."}
            </p>
...
export default LongTermProperties;

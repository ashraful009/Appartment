...
import { ImagePlus, X, Plus, Trash2, CheckCircle, AlertCircle, Upload, Building2 } from "lucide-react";
...
const AddBuilding = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast("success", "Building listed successfully! Images uploaded to Cloudinary.");
      ...
      showToast("error", err?.response?.data?.message || "Failed to add building.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-8 max-w-4xl">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-extrabold text-gray-800">Add Building</h1>
        <p className="text-gray-500 text-sm mt-1">List a new property — all images upload to Cloudinary.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-2">{extraFiles.length} / 10 images selected</p>
          </div>
        </div>
